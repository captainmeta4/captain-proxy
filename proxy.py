...
def main():
    ...
    parser.add_argument('--port', default=os.environ.get('PORT'), help='Default: 8899')
    parser.add_argument('--backlog', default='100', help='Default: 100. '
                                                         'Maximum number of pending connections to proxy server')
    parser.add_argument('--basic-auth', default=os.environ.get("auth", None), help='Default: No authentication. '
